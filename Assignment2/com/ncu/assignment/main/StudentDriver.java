...
public class StudentDriver
{
	public static void main(String args[])
	{
		...
		line1 = data.next();
		line1.studentValidator();

		System.out.println("Enter line2");
		line2 = data.next();
		line2.studentValidator();

		System.out.println("Enter city");
		city = data.next();
		city.studentValidator();

		System.out.println("Enter state");
		state = data.next();
		state.studentValidator();

		System.out.println("Enter pincode");
		pinCode = data.nextInt();		
		pinCode.studentValidator();
...
//		String skills;
		...
		//Qualification qual = new Qualification(qualName, university, institute, cgpa);
